...
public class IceloggedBlockEntity extends BlockEntity {
    ...
    public IceloggedBlockEntity(BlockPos pos, BlockState state) {
        super(IceloggedMod.ICELOGGED_BLOCK_ENTITY, pos, state);
    ...
    protected void applyImplicitComponents(DataComponentGetter dataComponentGetter) {
        ...
        IceloggedComponent component = dataComponentGetter.getOrDefault(IceloggedMod.ICELOGGED_COMPONENT, IceloggedComponent.DEFAULT);
    ...
    protected void collectImplicitComponents(DataComponentMap.Builder builder) {
        ...
        builder.set(IceloggedMod.ICELOGGED_COMPONENT, new IceloggedComponent(innerState, innerBlockEntity));
    }
